                  ...
                  <div className="col-50">
                    ...
                    <div className="row">
                      <div className="col-50">
                        ...
                        <input type="text" id="stockNum" name="stockNum" placeholder="123456789" />
                      </div>
                      <input type="submit" defaultValue="Submit" className="btn" />
                      <div className="col-50">
                        <label htmlFor="vinNum">Vin Number</label>
                        <input type="text" id="vinNum" name="vinNum" placeholder="" />
                      </div>
                      <div className="col-50">
                      ...
                      <div className="col-50">
                        ...
                        <input type="text" id="miles" name="miles" placeholder="" />
                      </div>
                      <div className="col-50">
                        <label htmlFor="dates">Dates</label>
                        <input type="text" id="dates" name="dates" placeholder="" />
                      </div>
                      <div className="col-50">
                        <label htmlFor="purPrice">Purchase Price</label>
                        <input type="text" id="purPrice" name="purPrice" placeholder="" />
                      </div>
                      <div className="col-50">
                        <label htmlFor="datePur">Date Purchased</label>
                        <input type="text" id="datePur" name="datePur" placeholder="" />
                      </div>
                      <div className="col-50">
